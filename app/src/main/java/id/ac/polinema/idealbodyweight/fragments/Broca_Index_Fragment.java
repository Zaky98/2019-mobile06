 ...
 * {@link Broca_Index_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class Broca_Index_Fragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public Broca_Index_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_broca__index_, container, false);
